...
1. Вносить минимальное количество изменений.
В рамках выполнения задачи делать минимальные изменения. Чтобы было отчётливо видно решение.

2. Правило бойскаута.
Стараться после себя оставлять меньше технического долга и мусора. Это не должно противоречить пункту 1 и 5.

3. Не навреди.
Для существующего кода не делать хуже.

4. Не писать бессмысленный код.
Изменения должны быть либо очевидны, либо должно быть объяснение их необходимости. Это дополняет пункты 1 и 3.

5. Последовательные улучшения.
