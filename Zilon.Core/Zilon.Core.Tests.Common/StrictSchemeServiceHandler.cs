...
{
    internal class StrictSchemeServiceHandler<TScheme> : ISchemeServiceHandler<TScheme> where TScheme : class, IScheme
    {
        ...
        public StrictSchemeServiceHandler(ISchemeLocator locator)
        {
            _locator = locator;
        ...
        public StrictSchemeServiceHandler(ISchemeLocator locator, string directory) : this(locator)
        {
        ...
        public void LoadSchemes()
        {
            ...
            foreach (var file in files)
            {
                try
                {
                    ...
                    var scheme = JsonConvert.DeserializeObject<TScheme>(file.Content, settings);
