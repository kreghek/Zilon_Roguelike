...
namespace Zilon.SchemeEditor
{
    ...
    /// </summary>
    public sealed class EditorSchemeService : ISchemeService
    {
        ...
        public void UpdateScheme<TScheme>(TScheme scheme) where TScheme : class, IScheme
        {
            var handler = (EditorSchemeServiceHandler<TScheme>)GetHandler<TScheme>();
            handler.Update(scheme);
        }
    }
}