...
//        /// </summary>
//        //TODO Вероятно, этот тест должен быть переписан.
//        // Теперь это должны быть 2 теста 
//        // 1 один на модуль боевых действий, что он успешно перехватывает событие смены экипировки.
//        // 2 на модуль экипировки, что он корректно выбрасывает событие при смене экипировки.
//        [Test]
...
//            // ARRANGE
//            person.GetModule<ICombatActModule>().CalcCombatActs().ElementAt(0).Stats.Should().Be(tacticalActScheme.Stats);
//        }

//        /// <summary>
//        /// Тест проверяет, что при получении перка характеристики персонажа пересчитываются.
//        /// </summary>
//        //TODO Вероятно, этот тест должен быть переписан. См. первый тест. Сейчас класс персонажа - эот просто хранилище модулей.
//        [Test]
...
//        /// с определёнными тегами модификатор броска на эффективность действия увеличивается.
//        /// </summary>
//        //TODO Вероятно, этот тест должен быть переписан. См. первый тест. Сейчас класс персонажа - эот просто хранилище модулей.
//        [Test]
