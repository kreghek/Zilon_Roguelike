...
namespace Zilon.Core.Tests.Tactics
{
    ...
    public class ActorActUsageHandlerTests
    {
        ...
        /// </summary>
        [Test]
        public void ProcessActUsage_ArmorSavePassed_ActEfficientDecrease()
        {
            // ARRANGE
        ...
        /// </summary>
        [Test]
        public void ProcessActUsage_Attack_RaiseUsedAct()
        {
            // ARRANGE
        ...
        public void UseOn_DecreaseBullets_BulletRemovedFromInventory()
        {
            ...
            // ACT
            var usedActs = new TacticalActRoll(shootAct, 1);
            actUsageService.ProcessActUsage(actor, monster, usedActs);
