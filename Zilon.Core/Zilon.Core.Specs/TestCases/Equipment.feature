...
Scenario Outline: Двуручное оружие вытесняет одноручное при экипировке, вытесненное оружие возвращается обратно в инвентарь
	...
	And Жду 1000 единиц времени
	Then В слоте Index: <rightHandSlotIndex> актёра игрока есть <propSid3>
	And В слоте Index: <leftHandSlotIndex> актёра игрока ничего нет
	And У актёра в инвентаре есть <propSid1>
	And У актёра в инвентаре есть <propSid2>

	Examples: 
	| propSid1    | slotHandIndex1 | propSid2    | slotHandIndex2 | propSid3    | rightHandSlotIndex | leftHandSlotIndex |
	| short-sword | 2              | short-sword | 3              | great-sword | 2                  | 3                 | -- два коротких меча в обоих руках - левая, правая руки
	| short-sword | 3              | short-sword | 2              | great-sword | 2                  | 3                 | -- два коротких меча в обоих руках - правая, левая руки
	| short-sword | 2              | short-sword | 2              | great-sword | 2                  | 3                 | -- вытесняем короткие мечи в правой руке, а затем вытесняем двуручным мечом для той же руки
	| short-sword | 3              | short-sword | 3              | great-sword | 2                  | 3                 | -- вытесняем короткие мечи в левой руке, а затем вытесняем двуручным мечом для той же руки
