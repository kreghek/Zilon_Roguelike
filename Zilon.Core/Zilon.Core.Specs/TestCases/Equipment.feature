...
@equipment @dev17
Scenario Outline: Двуручное оружие вытесняет одноручное при экипировке.
	Given Актёр игрока экипирован предметом <propSid1> в слот Index: <slotIndex1>
	And Актёр игрока экипирован предметом <propSid2> в слот Index: <slotIndex2>
	And В инвентаре у актёра игрока есть предмет: <propSid3>
	When Экипирую предмет <propSid3> в слот Index: <slotIndex3>
	And Жду 1000 единиц времени
	Then В слоте Index: <testSlotIndex> актёра игрока есть <propSid3>
	And У актёра в инвентаре есть <propSid3>

	Examples: 
	| propSid1    | slotIndex1 | propSid2    | slotIndex2 | propSid3    | slotIndex3 | testSlotIndex |
	| short-sword | 2          | short-sword | 3          | great-sword | 3          | 2             |
	| short-sword | 2          | short-sword | 3          | great-sword | 2          | 2             |
