...
@equipment @dev17
Scenario Outline: Двуручное оружие вытесняет одноручное при экипировке, вытесненное оружие возвращается обратно в инвентарь
	...
	And В инвентаре у актёра игрока есть предмет: <propSid3>
	When Экипирую предмет <propSid3> в слот Index: <slotHandIndex2>
	And Жду 1000 единиц времени
	Then В слоте Index: <slotHandIndex1> актёра игрока есть <propSid3>
	And В слоте Index: <testSlotIndex23> актёра игрока ничего нет
	And У актёра в инвентаре есть <propSid1>
	And У актёра в инвентаре есть <propSid2>

	Examples: 
	| propSid1    | slotHandIndex1 | propSid2    | slotHandIndex2 | propSid3    | testSlotIndex23 |
	| short-sword | 2              | short-sword | 3              | great-sword | 2               | -- два коротких меча в обоих руках - левая, правая руки                
	| short-sword | 3              | short-sword | 2              | great-sword | 2               | -- два коротких меча в обоих руках - правая, левая руки
	| short-sword | 2              | short-sword | 2              | great-sword | 2               | -- вытесняем короткие мечи в правой руке, а затем вытесняем двуручным мечом для той же руки
	| short-sword | 3              | short-sword | 3              | great-sword | 3               | -- вытесняем короткие мечи в левой руке, а затем вытесняем двуручным мечом для той же руки
	| short-sword | 2              | short-sword | 2              | great-sword | 3               | -- вытесняем короткие мечи в правой руке, а затем вытесняем двуручным мечом через левую руку
	| short-sword | 3              | short-sword | 3              | great-sword | 2               | -- вытесняем короткие мечи в левой руке, а затем вытесняем двуручным мечом через правую руку
