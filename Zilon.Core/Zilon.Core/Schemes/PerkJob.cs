...
{
    /// <summary>
    /// Структура для хранения работы перка.
    /// </summary>
    /// <remarks>
    /// Используется для хранения треюуемых работ, а так же хранения текущего прогресса по работам.
    /// </remarks>
    //TODO Нужно будет сделать абстрактным, и разделить на два класса - подсхема и текущих прогресс.
    public sealed class PerkJob
    {
        public JobType Type;
        public int Progress;
