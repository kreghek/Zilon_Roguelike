namespace Zilon.Core.Schemes
{
    ...
    [JsonSubtypes.KnownSubType(typeof(SectorCellularAutomataMapFactoryOptionsSubScheme),
        nameof(SchemeSectorMapGenerator.CellularAutomaton))]
    [JsonSubtypes.KnownSubType(typeof(SectorRoomMapFactoryOptionsSubScheme),
