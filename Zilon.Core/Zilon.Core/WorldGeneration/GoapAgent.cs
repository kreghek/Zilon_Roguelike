...
{
    public class ReGoapAgent<T, W> : IReGoapAgent<T, W>, IReGoapAgentHelper
    {
        public string Name;
        ...
        public virtual void RefreshGoalsSet()
        {
            ...
            //    new IReGoapGoal<T, W>[] {
            //        (IReGoapGoal<T, W>)new AgentGoals.BuildLocalityStructureGoal()
            //    }
            //    );
        ...
        {
            //actions = new List<IReGoapAction<T, W>>(new IReGoapAction<T, W>[] {
            //    new AgentActions.CollectResourceAction(),
            //    (IReGoapAction<T, W>)new AgentActions.BuildLocalityStructureAction()
            //});
        }
