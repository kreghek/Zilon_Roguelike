...
#line hidden
        ...
        public virtual void УгрозыВыживанияИмеютсяИзначальноСнижаютЭффективностьТактическихДействийУАктёраИгрока_(string mapSize, string personSid, string actorNodeX, string actorNodeY, string startEffect, string equipmentSid, string slotIndex, string tacticalActSid, string minEfficient, string maxEfficient, string[] exampleTags)
        {
...
#line hidden
        ...
        {
#line 7
this.УгрозыВыживанияИмеютсяИзначальноСнижаютЭффективностьТактическихДействийУАктёраИгрока_("2", "captain", "0", "0", "Слабый голод", "short-sword", "2", "chop", "9", "14", ((string[])(null)));
#line hidden
        }
        ...
        {
#line 7
this.УгрозыВыживанияИмеютсяИзначальноСнижаютЭффективностьТактическихДействийУАктёраИгрока_("2", "captain", "0", "0", "Голод", "short-sword", "2", "chop", "7", "11", ((string[])(null)));
#line hidden
        }
        ...
        {
#line 7
this.УгрозыВыживанияИмеютсяИзначальноСнижаютЭффективностьТактическихДействийУАктёраИгрока_("2", "captain", "0", "0", "Голодание", "short-sword", "2", "chop", "5", "8", ((string[])(null)));
#line hidden
        }
        ...
        {
#line 7
this.УгрозыВыживанияИмеютсяИзначальноСнижаютЭффективностьТактическихДействийУАктёраИгрока_("2", "captain", "0", "0", "Слабая жажда", "short-sword", "2", "chop", "9", "14", ((string[])(null)));
#line hidden
        }
        ...
        {
#line 7
this.УгрозыВыживанияИмеютсяИзначальноСнижаютЭффективностьТактическихДействийУАктёраИгрока_("2", "captain", "0", "0", "Жажда", "short-sword", "2", "chop", "7", "11", ((string[])(null)));
#line hidden
        }
        ...
        {
#line 7
this.УгрозыВыживанияИмеютсяИзначальноСнижаютЭффективностьТактическихДействийУАктёраИгрока_("2", "captain", "0", "0", "Обезвоживание", "short-sword", "2", "chop", "5", "8", ((string[])(null)));
#line hidden
        }
