...
namespace Zilon.Core.Spec.TestCases
{
    ...
    [TechTalk.SpecRun.FeatureAttribute("Equipment_DualPistols_Failure", Description="\tЧтобы ввести разнообразные сбособы экипировки и развития\r\n\tКак разработчику\r\n\tМн" +
        "е нужно, чтобы персонаж мог экипироваться и атаковать двумя оружиями.", SourceFile="TestCases\\Equipment_DualPistols_Failure.feature", SourceLine=0)]
    public partial class Equipment_DualPistols_FailureFeature
    {
        
        private TechTalk.SpecFlow.ITestRunner testRunner;
        
#line 1 "Equipment_DualPistols_Failure.feature"
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Equipment_DualPistols_Failure", "\tЧтобы ввести разнообразные сбособы экипировки и развития\r\n\tКак разработчику\r\n\tМн" +
        ...
        public virtual void ЭкипировкаДвухПистолетовНеРазрешена_(string personSid, string propSid1, string slotIndex1, string propSid2, string slotIndex2, string[] exampleTags)
        {
            ...
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Экипировка двух пистолетов не разрешена.", null, @__tags);
#line 7
...
#line hidden
        ...
        {
#line 7
this.ЭкипировкаДвухПистолетовНеРазрешена_("human-person", "pistol", "2", "pistol", "3", ((string[])(null)));
#line hidden
        }
        ...
        {
#line 7
this.ЭкипировкаДвухПистолетовНеРазрешена_("human-person", "short-sword", "2", "pistol", "3", ((string[])(null)));
#line hidden
        }
